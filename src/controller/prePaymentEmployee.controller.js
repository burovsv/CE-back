...
class PrePaymentEmployeeController {
  async createPrePaymentEmployee(req, res) {
    ...
    const urlPost = `http://ExchangeHRMUser:k70600ga@192.168.240.196/zup_pay/hs/Exch_LP/prepaid_еxpense?id_city=${findSubdivision.idService}&id_cashbox=${cashBox.id_cashbox}&name_cashbox=${cashBox.name_cashbox.replace(/\s/g, '')}`;
    console.log(urlPost);
